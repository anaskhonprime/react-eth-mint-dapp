...
import { fadeInDownShorter, fadeInLeft, fadeInRight, fadeInUp } from "./animation";
...
function Guide() {
  return (
    <div className="mt-5 flex flex-col lg:flex-row justify-evenly items-center mb-5">
      <Reveal keyframes={fadeInLeft} duration={1000} delay={400}>
        <div className="max-w-md bg-[#ffffff1a] hover:bg-[#ffffff2f] transition duration-300 m-3 lg:m-0 ease-in-out space-y-7 w-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            ...
            <p className="mb-6 text-base lg:text-lg h-20 px-2 font-normal text-[#ffffff66] dark:text-gray-400">
              5,555 unique collectible characters with proof of ownership stored
              on the Ethereum blockchain.
            </p>
            <a
              href="#"
              className=" inline-flex btn_primary items-center ml-2 my-5 px-5 py-2 text-medium font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Learn More
              <svg
                aria-hidden="true"
      ...
      <Reveal keyframes={fadeInRight} duration={1000} delay={500}>
        <div className="max-w-md bg-[#ffffff1a] hover:bg-[#ffffff2f] transition duration-300 ease-in-out m-3  lg:m-0 space-y-7 w-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="flex items-center justify-center ">
            <img
          ...
          <div className="p-5">
            ...
            <p className="mb-6 text-base lg:text-lg h-20 px-2 font-normal text-[#ffffff66] dark:text-gray-400">
              Project pre-date the ERC-721 standard and are a custom contract,
              it doesn't comply with any standards.
            </p>
            <div className=" inline-flex btn_primary items-center ml-2 my-5 px-5 py-2 text-medium font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Learn More
              <svg
                aria-hidden="true"
                className="w-4 h-4 ml-2 -mr-1"
